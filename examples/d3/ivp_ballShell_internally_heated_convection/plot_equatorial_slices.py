...
plotter.add_ball_shell_polar_colormesh(ball='TB eq', shell='TS eq', azimuth_basis='phi', radial_basis='r', remove_x_mean=True, divide_x_std=True, r_inner=r_inner, r_outer=r_outer)
